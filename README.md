...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/weathered-firefly-a447
```

A live public deployment of this template is available at [https://weathered-firefly-a447.templates.workers.dev](https://weathered-firefly-a447.templates.workers.dev)
